...
import type { LocaleConfig } from "../src/types/index.js";

const enHero = defineHeroConfig({
  name: "Cheng Shang",
...
const enContents = defineContents([
  {
    type: "profile",
    id: "profile",
    title: "Profile",
      ...
      fields: [
        {
          ...
          value: "Analytical Quantum Complexity RIKEN Hakubi Research Team",
        },
        {
          title: "Interests",
          icon: "heart",
  ...
  },
  {
    ...
    data: [
      ...
      },
      {
        year: 2021,
        content:
          "Joined the [Hatano Laboratory](http://hatano-lab.iis.u-tokyo.ac.jp/index-e.html) at the University of Tokyo as a MEXT Scholarship doctoral student.",
      },
      {
        year: 2019,
        content:
          "Gave a talk at the Symposium on Frontiers and Progress in Quantum Physics at Inner Mongolia University.",
      },
      {
        year: 2017,
        content:
          "Joined Prof. [Yi Xuexi's laboratory](https://cqs.nenu.edu.cn/) at the Center for Quantum Sciences for Master's research.",
      },
    ],
  },
  {
...
const enFooter = defineFooterConfig({
...
const zhFooter = defineFooterConfig({
  copyright: "© 2025 尚 程. 保留所有权利。",
  description: "以物理之名，致敬热爱。",
});

const zhContents = defineContents([
  {
    type: "profile",
    id: "profile",
    title: "个人简介",
...
export const zhLocale: LocaleConfig = {
  title: "尚程 | 个人主页",
  langName: "中文",
  ui: {
    themeToggle: "切换主题",
